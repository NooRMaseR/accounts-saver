    ...
    return Container(
      ...
      child: ClipRRect(
        ...
        child: Card(
          ...
          child: InkWell(
            onTap: () {},
            child: Consumer<CurrentExpandedAccount>(
              builder: (context, accountState, child) {
                if (
                  accountState.currentAccountId == widget.account.id 
                  && !isExpanded
                  && accountState.previosAccountId != null) {
                  WidgetsBinding.instance.addPostFrameCallback((_) {
                    cardController.expand();
                  });
                } else if (accountState.previosAccountId == widget.account.id &&
                    isExpanded) {
                  WidgetsBinding.instance.addPostFrameCallback((_) {
